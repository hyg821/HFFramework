...
public class ILRuntimeCLRBinding
{
    ...
    static void GenerateCLRBindingByAnalysis()
    {
        ...
        using (System.IO.FileStream fs = new System.IO.FileStream("Assets/StreamingAssets/DLL/"+GameEnvironment.HotFixDLLName+ ".dll", System.IO.FileMode.Open, System.IO.FileAccess.Read))
        {
