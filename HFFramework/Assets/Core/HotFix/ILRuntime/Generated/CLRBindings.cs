...
namespace ILRuntime.Runtime.Generated
{
    class CLRBindings
    {
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            System_Collections_Generic_Dictionary_2_Int64_ILTypeInstance_Binding_Enumerator_Int64_ILTypeInstance_Binding.Register(app);
            System_Collections_Generic_KeyValuePair_2_Int64_ILTypeInstance_Binding.Register(app);
            System_IDisposable_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_Object_Binding_Enumerator_Int32_Object_Binding.Register(app);
