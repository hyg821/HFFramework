...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UniRx_Async_CompilerServices_AsyncUniTaskMethodBuilder_1_GameObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(UniRx.Async.UniTask<UnityEngine.GameObject>.Awaiter), typeof(global::IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(UniRx.Async.UniTask<UnityEngine.GameObject>.Awaiter).MakeByRefType(), typeof(global::IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* AwaitUnsafeOnCompleted_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UniRx.Async.UniTask<UnityEngine.GameObject>.Awaiter @awaiter = (UniRx.Async.UniTask<UnityEngine.GameObject>.Awaiter)typeof(UniRx.Async.UniTask<UnityEngine.GameObject>.Awaiter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
