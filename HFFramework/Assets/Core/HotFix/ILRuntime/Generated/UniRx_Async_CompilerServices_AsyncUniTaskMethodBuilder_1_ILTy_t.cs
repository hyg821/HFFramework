...
{
    unsafe class UniRx_Async_CompilerServices_AsyncUniTaskMethodBuilder_1_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UniRx.Async.CompilerServices.AsyncUniTaskMethodBuilder<ILRuntime.Runtime.Intepreter.ILTypeInstance>);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UniRx.Async.CompilerServices.AsyncUniTaskMethodBuilder<ILRuntime.Runtime.Intepreter.ILTypeInstance>());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref UniRx.Async.CompilerServices.AsyncUniTaskMethodBuilder<ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as UniRx.Async.CompilerServices.AsyncUniTaskMethodBuilder<ILRuntime.Runtime.Intepreter.ILTypeInstance>[];
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UniRx.Async.CompilerServices.AsyncUniTaskMethodBuilder<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Create();
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UniRx.Async.CompilerServices.AsyncUniTaskMethodBuilder<ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method = (UniRx.Async.CompilerServices.AsyncUniTaskMethodBuilder<ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(UniRx.Async.CompilerServices.AsyncUniTaskMethodBuilder<ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
