...
{
    unsafe class UniRx_Async_CompilerServices_AsyncUniTaskVoidMethodBuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(UniRx.Async.UniTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Awaiter), typeof(global::IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(UniRx.Async.UniTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Awaiter).MakeByRefType(), typeof(global::IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder[];
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder.Create();
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder instance_of_this_method = (UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder)typeof(UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* AwaitUnsafeOnCompleted_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UniRx.Async.UniTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Awaiter @awaiter = (UniRx.Async.UniTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Awaiter)typeof(UniRx.Async.UniTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Awaiter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder instance_of_this_method = (UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder)typeof(UniRx.Async.CompilerServices.AsyncUniTaskVoidMethodBuilder).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

            instance_of_this_method.AwaitUnsafeOnCompleted<UniRx.Async.UniTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Awaiter, global::IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor>(ref @awaiter, ref @stateMachine);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as UniRx.Async.UniTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Awaiter[];
