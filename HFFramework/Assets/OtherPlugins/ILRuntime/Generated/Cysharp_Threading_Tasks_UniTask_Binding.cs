...
{
    unsafe class Cysharp_Threading_Tasks_UniTask_Binding
    {
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref Cysharp.Threading.Tasks.UniTask instance_of_this_method)
        {
        ...
        static StackObject* Delay_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Cysharp.Threading.Tasks.PlayerLoopTiming @delayTiming = (Cysharp.Threading.Tasks.PlayerLoopTiming)typeof(Cysharp.Threading.Tasks.PlayerLoopTiming).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* GetAwaiter_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            Cysharp.Threading.Tasks.UniTask instance_of_this_method = (Cysharp.Threading.Tasks.UniTask)typeof(Cysharp.Threading.Tasks.UniTask).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
