...
{
    unsafe class Cysharp_Threading_Tasks_UniTask_Binding_Awaiter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Cysharp.Threading.Tasks.UniTask.Awaiter);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Cysharp.Threading.Tasks.UniTask.Awaiter());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref Cysharp.Threading.Tasks.UniTask.Awaiter instance_of_this_method)
        {
        ...
        static StackObject* get_IsCompleted_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            Cysharp.Threading.Tasks.UniTask.Awaiter instance_of_this_method = (Cysharp.Threading.Tasks.UniTask.Awaiter)typeof(Cysharp.Threading.Tasks.UniTask.Awaiter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
