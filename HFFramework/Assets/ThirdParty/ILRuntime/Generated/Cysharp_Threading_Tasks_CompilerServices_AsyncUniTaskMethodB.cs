...
{
    unsafe class Cysharp_Threading_Tasks_CompilerServices_AsyncUniTaskMethodBuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter), typeof(global::IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter).MakeByRefType(), typeof(global::IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder[];
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder.Create();
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder instance_of_this_method = (Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder)typeof(Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
        ...
        static StackObject* AwaitUnsafeOnCompleted_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter @awaiter = (Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter)typeof(Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)16);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder instance_of_this_method = (Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder)typeof(Cysharp.Threading.Tasks.CompilerServices.AsyncUniTaskMethodBuilder).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);

            instance_of_this_method.AwaitUnsafeOnCompleted<Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter, global::IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor>(ref @awaiter, ref @stateMachine);
