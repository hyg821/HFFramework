...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Cysharp_Threading_Tasks_UniTask_1_GameObject_Binding_Awaiter_Binding
    {
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter instance_of_this_method)
        {
        ...
        static StackObject* get_IsCompleted_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter instance_of_this_method = (Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter)typeof(Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
