...
{
    unsafe class HFFramework_GameFactory_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(HFFramework.GameFactory);
        ...
        static StackObject* InstantiateAsync_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = HFFramework.GameFactory.InstantiateAsync(@prefab);
