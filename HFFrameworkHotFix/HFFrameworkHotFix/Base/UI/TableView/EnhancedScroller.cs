...
namespace HotFix
{
    ...
    public class EnhancedScroller : BaseElement
    {
        ...
        public int NumberOfCells
        {
            get
            {
                return (Delegate != null ? Delegate.GetNumberOfCells(this) : 0);
            }
        }
        ...
        /// <returns></returns>
        public TV GetCellView<TV>(string id) where TV:EnhancedScrollerCellView , new()
        {
            // see if there is a view to recycle
            var cellView = _GetRecycledCellView(id);
            if (cellView == null)
            {
            ...
            )
        {
            ...
            if (cellOffset != 0)
            {
                ...
                // get the cell's size
                var cellSize = (Delegate != null ? Delegate.GetCellViewSize(this, dataIndex) : 0);
        ...
        {
            return GetScrollPositionForCellViewIndex(loop ? Delegate.GetNumberOfCells(this) + dataIndex : dataIndex, insertPosition);
        }
        ...
        /// </summary>
        private BigList<EnhancedScrollerCellView> _recycledCellViews = new BigList<EnhancedScrollerCellView>();
        ...
        /// </summary>
        private BigList<EnhancedScrollerCellView> _activeCellViews = new BigList<EnhancedScrollerCellView>();
        ...
        private float _AddCellViewSizes()
        {
            ...
            for (var i = 0; i < NumberOfCells; i++)
            {
                ...
                _cellViewSizeArray.Add(Delegate.GetCellViewSize(this, i) + (i == 0 ? 0 : _layoutGroup.spacing));
        ...
        /// <returns></returns>
        private EnhancedScrollerCellView _GetRecycledCellView(string id)
        {
            for (var i = 0; i < _recycledCellViews.Count; i++)
            {
                if (_recycledCellViews[i].cellIdentifier == id)
                {
        ...
        private void _AddCellView(int cellIndex, ListPositionEnum listPosition)
        {
            ...
            var cellView = Delegate.GetCellView(this, dataIndex, cellIndex);
            ...
            LayoutElement layoutElement = cellView.gameObject.GetComponent<LayoutElement>();
        ...
        public override void Awake()
        {
            ...
            {
                GameObject.Destroy(_scrollRect.content.gameObject);
            }
